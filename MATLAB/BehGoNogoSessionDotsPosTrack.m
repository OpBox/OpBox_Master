...
pos_filename = [filename(1:end-4) '.trk'];
...
clf;
grid_axes = AxesGrid(numel(all_stim_ids)+1 + flag_pos, 1);
...
if flag_pos
    pos_data = PosTrackLoadBinary(pos_filename);
end
